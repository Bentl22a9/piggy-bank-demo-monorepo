...
export const EthersProvider = new ethers.JsonRpcProvider(JSON_RPC_URL);
export const PiggyFrens = new ethers.Contract(
  PIGGY_FRENS_CONTRACT_ADDRESS,
  piggyFrensAbi,
  EthersProvider
);
export const PiggyBankVault = new ethers.Contract(
